...
public class DatabaseContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            new Race() {RaceId = 1, Name = "British Grand Prix", Location = "Silverstone, UK", Date = DateTime.Parse("2025-07-14")},
            new Race() {RaceId = 2, Name = "Monaco Grand Prix", Location = "Monte Carlo, Monaco", Date = DateTime.Parse("2025-05-25")},
        });
